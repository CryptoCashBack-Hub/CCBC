...
In order to support loading of multiple wallets in smrtc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is smrtc.cpp.
...
Changes to smrtc.cpp
----------------------
smrtc.cpp is the entry point into smrtc-qt, and as such, will require some minor modifications to provide hooks for

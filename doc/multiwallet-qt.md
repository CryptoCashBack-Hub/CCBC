...
In order to support loading of multiple wallets in ccbc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ccbc.cpp.
...
Changes to ccbc.cpp
----------------------
ccbc.cpp is the entry point into ccbc-qt, and as such, will require some minor modifications to provide hooks for

...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a CCBC address (e.g. %1)").arg("SbUrNmfY8pfDVLNtXsedwLTz1QY481hEBn"));
#endif
...
{
    // Convert ccbc:// to ccbc:
    //
    //    Cannot handle this later, because ccbc:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open ccbc.conf with the associated application */
...
{
    return GetAutostartDir() / "ccbc.desktop";
}
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the ccbc app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add ccbc app to startup item list

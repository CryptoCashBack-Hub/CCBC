                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Xxx from zSmrtc"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSmrtc"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zXxx));
